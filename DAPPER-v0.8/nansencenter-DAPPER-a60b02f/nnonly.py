...
datadir = 'example_nn_data'  # Directory where to save the results
######################
# Initial simulation #
######################
...
fig = nn.plot_history()
# save fig
fig.savefig(os.path.join(datadir, 'hist.png'))
